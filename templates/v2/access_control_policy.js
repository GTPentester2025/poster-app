// v2 template — access-control-policy (style: infographic). A faithful port of
...
export default {
  ...
  style: 'infographic',
  description: 'A dark multi-section policy infographic: bold yellow header band, a grid of policy section panels (each with a heading chip and body text), a ghosted padlock motif, a dark callout footer with a QR/logo image slot, and a yellow CTA tagline bar.',
  contentSchema: {
